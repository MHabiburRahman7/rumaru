...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="<?php echo base_url();?><?php echo base_url();?>images/properties/1.jpg" class="img-responsive img-circle" alt="properties"></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="<?php echo base_url();?>index.php/auth/property_detail">Integer sed porta quam</a></h5>
