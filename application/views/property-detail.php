...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="<?php echo base_url();?>images/properties/4.jpg" class="img-responsive img-circle" alt="properties"/></div>
...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="<?php echo base_url();?>images/properties/3.jpg" class="img-responsive img-circle" alt="properties"/></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p> </div>
              </div>
...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="<?php echo base_url();?>images/properties/2.jpg" class="img-responsive img-circle" alt="properties"/></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p> </div>
              </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="<?php echo base_url();?>images/properties/4.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->

        <!-- Item 2 -->
        <div class="item">
          <img src="<?php echo base_url();?>images/properties/2.jpg" class="properties" alt="properties" />
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="<?php echo base_url();?>images/properties/1.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="<?php echo base_url();?>images/properties/3.jpg" class="properties" alt="properties" />
...
<div class="col-lg-12 col-sm-6 ">
<div class="enquiry">
  <h6><span class="glyphicon glyphicon-envelope"></span> Schedule your tour</h6>
	<form role="form">
		<div class='container' style="margin-right:0px; width:100%">
					<div class="form-group">
						<div class='input-group date' id='datetimepicker1'>
							<input type='text' class="form-control" placeholder="select time and date"/>
			...
			<a type="submit" class="btn btn-primary" name="Submit">Schedule tour</a>
		</div>
		<!--
...
<div class="enquiry">
  <h6><span class="glyphicon glyphicon-envelope"></span>Contact us</h6>
		...
		<a type="submit" class="btn btn-primary" name="Submit" style="width: 40%">Make offer</a>
		<!--
                <input type="text" class="form-control" placeholder="Full Name"/>
                <input type="text" class="form-control" placeholder="you@yourdomain.com"/>
                <input type="text" class="form-control" placeholder="your number"/>
